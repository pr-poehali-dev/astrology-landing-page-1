...
const benefits = [
  { icon: "Compass", text: "3 конкретные бизнес-ниши с обоснованием — подходящие именно под вашу натальную карту" },
  { icon: "TrendingUp", text: "Анализ потенциала в сферах: торговля, финансы, производство, IT, консалтинг и другие" },
  { icon: "Users", text: "Рекомендации по типу партнёрства и структуре команды, которая усилит вас" },
  { icon: "ShieldCheck", text: "Конфиденциально: ваше имя не появится нигде. PDF-отчёт за 24 часа" },
];

export default function LandingBusiness() {
  const [formData, setFormData] = useState({ name: "", phone: "+7 ", birth: "", comment: "", source: "landing-business" });
  ...
  return (
    <div className="min-h-screen bg-[#050A14] text-white font-montserrat">
      <Helmet>
        <title>Подбор бизнес-направления по натальной карте — StarsBiz</title>
        <meta name="description" content="Астрологический подбор ниши для бизнеса под вашу натальную карту. 3 конкретные сферы с обоснованием. Конфиденциально, PDF-отчёт за 24 часа." />
        <link rel="canonical" href="https://starsbiz.ru/business" />
      ...
      <main className="max-w-2xl mx-auto px-6 py-12 space-y-12">
        ...
        <section className="space-y-5 text-center">
          ...
          <h1 className="font-cormorant text-4xl md:text-5xl font-light leading-tight">
            Какой бизнес подойдёт<br />
            <span className="text-[#D4AF37] italic">именно вам</span><br />
            по натальной карте
          </h1>
          <p className="text-white/60 text-base leading-relaxed max-w-lg mx-auto">
            Анализ вашего потенциала и 3 конкретные бизнес-ниши с обоснованием.
            Без общих слов — только то, в чём вы будете сильны и что принесёт результат.
          </p>
        ...
        <section className="bg-[#0A1020] border-l-2 border-[#D4AF37] pl-6 pr-5 py-6 space-y-3">
          ...
          <p className="font-cormorant text-xl italic text-white/90 leading-snug">
            «Заказывала подбор бизнес-направления. Отчёт чёткий, без воды — три конкретные
            ниши с обоснованием. Одну уже запустила, результаты превзошли ожидания.»
          </p>
          <div className="flex items-center gap-3 pt-1">
            <div className="w-8 h-px bg-[#D4AF37]/40" />
            <span className="text-white/40 text-xs">Наталья Ш., предприниматель, Краснодар</span>
          </div>
        </section>
        ...
        <section className="space-y-6">
          <div className="text-center space-y-1">
            <h2 className="font-cormorant text-3xl font-light">Получить анализ</h2>
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              />
              <textarea
                placeholder="Расскажите о текущей ситуации: чем занимаетесь сейчас, что хотите изменить?"
                rows={3}
