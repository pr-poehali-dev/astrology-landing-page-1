...
const services = [
  ...
  {
    title: "Ректификация",
    sub: "Уточнение времени рождения",
    price: "5 000 ₽",
    desc: "Вы не знаете точное время рождения? Мы определим его с точностью до 5–10 минут. Для этого нужно предоставить 3–8 дат важных событий из вашей жизни (свадьба, рождение детей, переезды, крупные покупки). Без этой услуги прогноз может быть неточным на 30–50%.",
    icon: "ScanSearch",
  },
];
          ...
          >
            ...
            <form onSubmit={handlePaySubmit} className="space-y-4">
              <select
                ...
                onChange={(e) => {
                  const prices: Record<string, string> = {
                    ...
                    "Ректификация (уточнение времени рождения)": "5000",
                    "Другое": "0",
                  };
              ...
              >
                ...
                <option>Ректификация (уточнение времени рождения)</option>
